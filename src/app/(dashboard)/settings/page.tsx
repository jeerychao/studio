...
// Removed: import { ThemeToggle } from "@/components/settings/theme-toggle";
  ...
  return (
    <>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {/* Theme Toggle Card has been removed from here */}
        ...
        <Card className="md:col-span-2 lg:col-span-3">
          ...
          <CardContent>
            <p className="text-muted-foreground">暂无其他系统级配置项。</p>
          </CardContent>
        </Card>
      </div>
    </>
